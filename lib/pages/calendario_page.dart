              ...
              Center(
                child: TextButton(
                  ...
                  onPressed: () {
                    ...
                    String todo1 = fechaInicio.selectedDate!.day.toString();
                    String fechaInicioFormateada = formatearFecha(todo1);

                    String todo2 = fechaFin.selectedDate!.day.toString();
    ...
    return TableCalendar(
      ...
      calendarBuilders: CalendarBuilders(
        selectedBuilder: (context, day, events) => Container(
          ...
          child:
              Text(day.toString(), style: const TextStyle(color: Colors.white)),
        ),
